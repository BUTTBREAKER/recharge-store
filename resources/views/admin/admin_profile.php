<div class="max-w-4xl mx-auto animate-fade-in">
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-500 mt-1">Administrador</p>
        </div>
        <a href="/admin/dashboard" class="bg-violet-100 text-violet-700 hover:bg-violet-200 px-5 py-2.5 rounded-xl font-bold transition">
            Volver al Dashboard
        </a>
    </div>
    ...
    <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded-r-xl">
        <div class="flex items-center">
            ...
            <p class="text-red-700 font-medium">Contraseña actual incorrecta</p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 text-center">
                <div class="w-24 h-24 bg-gradient-to-br from-violet-500 to-purple-600 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-3xl font-bold">
                ...
                <span class="inline-block mt-3 px-3 py-1 bg-violet-100 text-violet-700 text-xs font-bold rounded-full">
                    ADMINISTRADOR
                </span>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <form action="/admin/profile/update" method="POST" class="p-6 space-y-5">
                    <div>
                    ...
                    <button type="submit" class="w-full bg-violet-600 hover:bg-violet-700 text-white font-bold py-3 px-6 rounded-xl transition">
