<div class="max-w-xl mx-auto text-center animate-fade-in">
    <div class="bg-card p-10 rounded-3xl shadow-xl border border-border">
        <div class="mb-8">
            <div class="w-20 h-20 bg-yellow-500/10 text-yellow-500 rounded-3xl flex items-center justify-center mx-auto text-4xl mb-4 rotate-3 shadow-lg shadow-yellow-500/20">
            ...
            <h1 class="text-3xl font-bold text-foreground">Binance Pay</h1>
            <p class="text-muted-foreground mt-2">Escanea el código QR desde tu app</p>
        </div>
        ...
        <a href="<?= $url ?>" target="_blank" class="block w-full bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-4 px-6 rounded-2xl shadow-lg transition duration-300 mb-4 flex items-center justify-center">
        ...
        <a href="./pago/estado/<?= $pedido['id'] ?>" class="text-sm text-muted-foreground hover:text-primary font-medium transition-colors">
