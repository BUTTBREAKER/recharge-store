...
<div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-violet-100 to-indigo-50 mb-16 animate-fade-in">
            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        ...
                        <span class="block text-violet-600">Recarga Diamantes al instante</span>
                    </h1>
                    ...
                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                        <div class="rounded-md shadow">
                            <a href="#games" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-primary hover:bg-primary-dark md:py-4 md:text-lg md:px-10 transition-colors duration-200">
                                Recargar Ahora
                            </a>
                        </div>
                    </div>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 flex items-center justify-center bg-violet-200/50 backdrop-blur-sm">
        <!-- Placeholder for Game Image - Using a decorative element for MVP -->
        <div class="text-[120px] animate-float opacity-80">
            ⚔️
        </div>
    </div>
</div>
